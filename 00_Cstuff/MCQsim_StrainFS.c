...
void _qpki7p5(double _yr06nkw[3], double _kvl9ptk, double _112hxrj, double _mdmmmxi, double _s3kkv9r[3][3]);
void _5uofwb0(int _rpj1epk[1], double x,double y,double z,double _jz0ifrm,double _l29q2l4, double _33e1i1p,double _0bq1s9r,double _jwh55he,double _wlgje2a);
void _ulemx15(double _ihx74d0[6], double _z36u8ue[6], double B[3][3]);
void _ilgb0s0(double x,double y,double z,double _tj1gm25,double _wk8r2yk,double _ccprhvl,double _lqjidkn,double _gdc5tao, double _dbfwyjx[3],double _vxpj4hn[3],double e[6]);
void _ikcidkw(double x, double y, double z, double _tj1gm25, double _wk8r2yk, double _ccprhvl, double _lqjidkn, double _gdc5tao, double e[6]);
void StrainFS_Nikkhoo(float _d5eqy08[6], float _82n2atq[6], float _ji9kqdg, float _b4xgmpw, float _5d3go8j, float _2c9t199[3], float _dxj37c9[3], float _h42m44g[3], float _dtg5nqj, float _gyspeng, float _0vgnxb5, const float _8bixoiq, const float _yn4u9bx)
{
    double X = (double)_ji9kqdg; double Y = (double)_b4xgmpw; double Z = (double)_5d3go8j;
    double _wk8r2yk = (double)_0vgnxb5; double _ccprhvl= (double)_dtg5nqj; double _lqjidkn= (double)_gyspeng;
    ...
    _qpki7p5(_laym0wb, (X-_b7r3ocw[0]), (Y-_b7r3ocw[1]), (Z-_b7r3ocw[2]), _4v30t9n);
    x = _laym0wb[0]; y = _laym0wb[1]; z = _laym0wb[2];
    _qpki7p5(_laym0wb, (_atj9tze[0]-_b7r3ocw[0]), (_atj9tze[1]-_b7r3ocw[1]), (_atj9tze[2]-_b7r3ocw[2]), _4v30t9n);
    _wgabtgd[0] = _laym0wb[0]; _wgabtgd[1] = _laym0wb[1]; _wgabtgd[2] = _laym0wb[2];
    _qpki7p5(_glmy62x, (_v2isqp4[0]-_b7r3ocw[0]), (_v2isqp4[1]-_b7r3ocw[1]), (_v2isqp4[2]-_b7r3ocw[2]), _4v30t9n);
    ...
    C = acos(_3dd03uv) ;
    _5uofwb0(_3jgzlma,y,z,x,_wgabtgd[1],_wgabtgd[2], _8c1cqg4[1], _8c1cqg4[2], _yllwb7s[1], _yllwb7s[2]);
    ...
    if (_t7zewvi == 1)
    {
        ...
        _ilgb0s0(x, y, z, A, _wk8r2yk, _ccprhvl, _lqjidkn, _gdc5tao, _wgabtgd, _laym0wb, _gjyv5g1);
        _ilgb0s0(x, y, z, B, _wk8r2yk, _ccprhvl, _lqjidkn, _gdc5tao, _8c1cqg4, _h5csk30, _0ur5l8a);
        _ilgb0s0(x, y, z, C, _wk8r2yk, _ccprhvl, _lqjidkn, _gdc5tao, _yllwb7s, _hkc856w, _78e9riv);
    }
    if (_kzmpjrh == 1)
    {
        _ilgb0s0(x, y, z, A, _wk8r2yk, _ccprhvl, _lqjidkn, _gdc5tao, _wgabtgd, _lvylkfx, _gjyv5g1);
        _laym0wb[0] = -1.0*_h5csk30[0]; _laym0wb[1] = -1.0*_h5csk30[1]; _laym0wb[2] = -1.0*_h5csk30[2];
        _ilgb0s0(x, y, z, B, _wk8r2yk, _ccprhvl, _lqjidkn, _gdc5tao, _8c1cqg4, _laym0wb, _0ur5l8a);
        _laym0wb[0] = -1.0*_hkc856w[0]; _laym0wb[1] = -1.0*_hkc856w[1]; _laym0wb[2] = -1.0*_hkc856w[2];
        _ilgb0s0(x, y, z, C, _wk8r2yk, _ccprhvl, _lqjidkn, _gdc5tao, _yllwb7s, _laym0wb, _78e9riv);
    }
    ...
    double _bmc97c7[6];
    _ulemx15(_bmc97c7, _ofn1r4k, _4v30t9n);
    for (i = 0; i < 6; i++) { _82n2atq[i] = (float)_bmc97c7[i]; }
...
void _qpki7p5(double _yr06nkw[3], double _znvp8gm, double _nhie9ed, double _e1zuble, double A[3][3])
{
...
void _5uofwb0(int _3jgzlma[1], double x,double y,double z,double _jz0ifrm,double _l29q2l4, double _33e1i1p,double _0bq1s9r,double _jwh55he,double _wlgje2a)
{
    double a, b, c;
    ...
    else if ((b <= 0.0) && (c > a) && (a > b)) { _3jgzlma[0] = -1; }
    else if ((c <= 0.0) && (a > b) && (b > c)) { _3jgzlma[0] = -1; }
    else if ((a == 0.0) && (b >= 0.0) && (c >= 0.0)) { _3jgzlma[0] = 0; }
    else if ((a >= 0.0) && (b == 0.0) && (c >= 0.0)) { _3jgzlma[0] = 0; }
    else if ((a >= 0.0) && (b >= 0.0) && (c == 0.0)) { _3jgzlma[0] = 0; }
    if ((_3jgzlma[0] == 0) && (z != 0.0)) { _3jgzlma[0] = 1; }
    return;
}
void _ilgb0s0(double x,double y,double z,double _tj1gm25,double _wk8r2yk,double _ccprhvl,double _lqjidkn,double _gdc5tao, double _dbfwyjx[3],double _vxpj4hn[3],double _ihx74d0[6])
{
    double A[2][2];
    double B[3][3];
    double _ln1p0vu[2];
    ...
    _ikcidkw(x, _4gc4ryg, _kzrezrd, (-1.0*3.14159265358979323846264338327950288 +_tj1gm25), _wk8r2yk, _z049enu, _wi5flul, _gdc5tao, e);
    B[0][0] = 1.0; B[0][1] = 0.0; B[0][2] = 0.0;
    B[1][0] = 0.0; B[1][1] = A[0][0]; B[1][2] = A[1][0];
    B[2][0] = 0.0; B[2][1] = A[0][1]; B[2][2] = A[1][1];
    _ulemx15(_ihx74d0, e, B);
    return;
}
void _ikcidkw(double x, double y, double z, double _tj1gm25, double _wk8r2yk, double _ccprhvl, double _lqjidkn, double _gdc5tao, double e[6])
{ double _qnsn2s8, _u1g463s, _nwywrra, _lq5u6jz;
    ...
    _nhie9ed = x*x; _ovd79c9 = y*y; _or8wm9l = z*z;
    _h17j8qo = _nhie9ed + _ovd79c9 + _or8wm9l; r = pow(_h17j8qo,0.5); _h4a3yjt = r*_h17j8qo;
    _j4x5a5x = r*(r-z); _09vs9kk = _h17j8qo*pow((r-z),2.0); _u7fbmen = _h4a3yjt*(r-z);
    W = _lq5u6jz-r; _k0qtl3q = W*W; _ioxd9cs = W*r;
    _4n89qkn= _k0qtl3q*r; _s9toqw9 = W*_h4a3yjt; _s832ejx= _k0qtl3q*_h17j8qo;
    ...
    _zhwjr64 = _wk8r2yk*(_ui3do70) +_wk8r2yk/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(_nwywrra/_ioxd9cs+_nwywrra*_nhie9ed/_s832ejx-_nwywrra*_nhie9ed/_s9toqw9+y/_j4x5a5x-_nhie9ed*y/_09vs9kk-_nhie9ed*y/_u7fbmen)
                       -_ccprhvl*x/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(((2.0*_gdc5tao+1.0)/_ioxd9cs+_nhie9ed/_s832ejx-_nhie9ed/_s9toqw9)*_u1g463s+(2.0*_gdc5tao+1.0)/_j4x5a5x-_nhie9ed/_09vs9kk-_nhie9ed/_u7fbmen)
                       +_lqjidkn*x*_qnsn2s8/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*((2.0*_gdc5tao+1.0)/_ioxd9cs+_nhie9ed/_s832ejx-_nhie9ed/_s9toqw9);
    _t4ufel6 = _ccprhvl*(_02g3yu6) +_wk8r2yk/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*((1.0/_ioxd9cs+S*S-_ovd79c9/_s9toqw9)*_nwywrra+(2.0*_gdc5tao+1.0)*y/_j4x5a5x-pow(y,3.0)/_09vs9kk-pow(y,3.0)/_u7fbmen-2.0*_gdc5tao*_u1g463s*S)
                       -_ccprhvl*x/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(1.0/_j4x5a5x-_ovd79c9/_09vs9kk-_ovd79c9/_u7fbmen+(1.0/_ioxd9cs+S*S-_ovd79c9/_s9toqw9)*_u1g463s)
                       +_lqjidkn*x*_qnsn2s8/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(1.0/_ioxd9cs+S*S-_ovd79c9/_s9toqw9);
    _5owf759 = _lqjidkn*(_vk0ucc1)+_wk8r2yk/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(_nwywrra/W/r+_nwywrra*C*C-_nwywrra*_or8wm9l/_s9toqw9+y*z/_h4a3yjt+2.0*_gdc5tao*_qnsn2s8*C)
                      -_ccprhvl*x/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*((1.0/_ioxd9cs+C*C-_or8wm9l/_s9toqw9)*_u1g463s+z/_h4a3yjt)
                      +_lqjidkn*x*_qnsn2s8/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(1.0/_ioxd9cs+C*C-_or8wm9l/_s9toqw9);
    _dpja1wj = _wk8r2yk*(_02g3yu6)/2.0+_ccprhvl*(_ui3do70)/2.0 -_wk8r2yk/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(x*_ovd79c9/_09vs9kk-_gdc5tao*x/_j4x5a5x+x*_ovd79c9/_u7fbmen-_gdc5tao*x*_u1g463s/_ioxd9cs+_nwywrra*x*S/_ioxd9cs+_nwywrra*x*y/_s9toqw9)
                                           +_ccprhvl/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(_nhie9ed*y/_09vs9kk-_gdc5tao*y/_j4x5a5x+_nhie9ed*y/_u7fbmen+_gdc5tao*_u1g463s*S+_nhie9ed*y*_u1g463s/_s9toqw9+_nhie9ed*_u1g463s*S/_ioxd9cs)
                                           -_lqjidkn*_qnsn2s8/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(_gdc5tao*S+_nhie9ed*S/_ioxd9cs+_nhie9ed*y/_s9toqw9);
    _0tpac56 = _wk8r2yk*(_vk0ucc1)/2.0+_lqjidkn*(_ui3do70)/2.0 -_wk8r2yk/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(-x*y/_h4a3yjt+_gdc5tao*x*_qnsn2s8/_ioxd9cs+_nwywrra*x*C/_ioxd9cs+_nwywrra*x*z/_s9toqw9)
                                           +_ccprhvl/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(-_nhie9ed/_h4a3yjt+_gdc5tao/r+_gdc5tao*_u1g463s*C+_nhie9ed*z*_u1g463s/_s9toqw9+_nhie9ed*_u1g463s*C/_ioxd9cs)
                                           -_lqjidkn*_qnsn2s8/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(_gdc5tao*C+_nhie9ed*C/_ioxd9cs+_nhie9ed*z/_s9toqw9);
    _246hid2 = _ccprhvl*(_vk0ucc1)/2.0+_lqjidkn*(_02g3yu6)/2.0 +_wk8r2yk/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(_ovd79c9/_h4a3yjt-_gdc5tao/r-_gdc5tao*_u1g463s*C+_gdc5tao*_qnsn2s8*S+_nwywrra*_qnsn2s8*_u1g463s/_k0qtl3q-_nwywrra*(y*_u1g463s+z*_qnsn2s8)/_4n89qkn+_nwywrra*y*z/_s832ejx-_nwywrra*y*z/_s9toqw9)
                                           -_ccprhvl*x/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(y/_h4a3yjt+_qnsn2s8*_u1g463s*_u1g463s/_k0qtl3q-_u1g463s*(y*_u1g463s+z*_qnsn2s8)/_4n89qkn+y*z*_u1g463s/_s832ejx-y*z*_u1g463s/_s9toqw9)
                                           -_lqjidkn*x*_qnsn2s8/8.0/3.14159265358979323846264338327950288/(1.0-_gdc5tao)*(y*z/_s9toqw9-_qnsn2s8*_u1g463s/_k0qtl3q+(y*_u1g463s+z*_qnsn2s8)/_4n89qkn-y*z/_s832ejx);
