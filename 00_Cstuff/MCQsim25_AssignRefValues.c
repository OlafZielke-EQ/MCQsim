...
void _z0yncxl(unsigned int _qy8yb7w, const unsigned int *restrict _06ftlo4, float *restrict _wkxxjve, const float *restrict _ypntrfz, float *restrict _h55rbc7, float *restrict _f445cri);
void _l4zkloo(int _20n8tte, unsigned int _pj8t22c, float *restrict _dhgzz0j, unsigned int _qy8yb7w, unsigned int *restrict _06ftlo4, float *restrict _wkxxjve, const float *restrict _ypntrfz, const unsigned int *restrict _qydbpgv, const int *restrict _zc7d2kd);
void AssignRefValues(int _20n8tte, struct _r1yxr2d *restrict _5zja8dz, struct _q0oxfq8 *restrict _z3nx39r, struct _wrdmly4 *restrict _lyk83tq, const int *restrict _b6gs8g8, const int *restrict _zfflb7w, const unsigned int *restrict _xo100vh, const unsigned int *restrict _g1ved32, float *restrict _cmktlzk, float *restrict _ldalmje, unsigned int *restrict _t4q9bc2, unsigned int *restrict _mgvu4is, float *restrict _qw5dsk7, float *restrict _rcpprcj, const float *restrict _z39pecn, const float *restrict _8e7flqh, float *restrict _3n3bzt9, float *restrict _mzwffhh, float *restrict _3p91i3v, float *restrict _m7pyxdw)
{
    unsigned int i;
    float _h55rbc7, _f445cri, _9p3jpxg;
    float _5bwikot[3];
    float _0dl5e11[6], _2292mtr[6];
    _h55rbc7 = 0.0f, _f445cri = 0.0f;
    _z0yncxl(_z3nx39r->_jp61lfc, _t4q9bc2, _qw5dsk7, _z39pecn, &_h55rbc7, &_f445cri);
    _lyk83tq->_n8la100 = _f445cri;
    _lyk83tq->_q01tee1 = _h55rbc7;
    _h55rbc7 = 0.0f, _f445cri = 0.0f;
    _z0yncxl(_z3nx39r->_urvqt3g, _mgvu4is, _rcpprcj, _8e7flqh, &_h55rbc7, &_f445cri);
    _lyk83tq->_lw2lm34 = _f445cri;
    _lyk83tq->_8o1bj9r = _h55rbc7;
    _lyk83tq->_6fokzix = _lyk83tq->_n8la100*1.0E-4f;
    _lyk83tq->_jssuuqo = (_lyk83tq->_8o1bj9r/_lyk83tq->_q01tee1)*_lyk83tq->_6fokzix;
    _5zja8dz->_pkxvhag = _5zja8dz->_pkxvhag*1.0E+9f;
    _5zja8dz->_9dde3cu = (2.0f*_5zja8dz->_pkxvhag*_5zja8dz->_uug95rl)/(1.0f-2.0f*_5zja8dz->_uug95rl);
    _9p3jpxg = (_5zja8dz->_xpbwhvn > 0.0f)*_5zja8dz->_xpbwhvn + (_5zja8dz->_xpbwhvn <= 0.0f)*2700.0f;
    _5zja8dz->_4yfds0d = sqrtf(_5zja8dz->_pkxvhag/_9p3jpxg);
    _5zja8dz->_gfu8iog = (1.0f*_lyk83tq->_n8la100) /(sqrtf((_5zja8dz->_9dde3cu +2.0f*_5zja8dz->_pkxvhag)/_9p3jpxg));
    _z3nx39r->_3ac6pe6 = _z3nx39r->_3ac6pe6*_5zja8dz->_gfu8iog;
    _l4zkloo(_20n8tte, _lyk83tq->_hx6zdcu, _cmktlzk, _z3nx39r->_jp61lfc, _t4q9bc2, _qw5dsk7, _z39pecn, _xo100vh, _b6gs8g8);
    _l4zkloo(_20n8tte, _lyk83tq->_fftouhy, _ldalmje, _z3nx39r->_urvqt3g, _mgvu4is, _rcpprcj, _8e7flqh, _g1ved32, _zfflb7w);
    for (i = 0u; i < _b6gs8g8[_20n8tte]; i++)
    {
        _3n3bzt9[i*16 +8] = _qw5dsk7[_xo100vh[i]*16 +15];
        _3n3bzt9[i*16 +2] = _5zja8dz->_xpbwhvn * 9.81f * _qw5dsk7[_xo100vh[i]*16 +2] +(_5zja8dz->_dntcagr*1.0E+6f);
        _9p3jpxg = ran0(&_5zja8dz->_k5ogz2u); _9p3jpxg = _9p3jpxg -0.5f;
        _9p3jpxg = _5zja8dz->_xpbwhvn * 9.81f *_lyk83tq->_n8la100*_9p3jpxg;
        _3n3bzt9[i*16 +2] = _3n3bzt9[i*16 +2] +_9p3jpxg;
        _mzwffhh[i*16 +0] = _3n3bzt9[i*16 +2];
        _3p91i3v[i*8 +0] = _qw5dsk7[_xo100vh[i]*16 +0];
        _3p91i3v[i*8 +1] = _qw5dsk7[_xo100vh[i]*16 +1];
        _3p91i3v[i*8 +2] = _qw5dsk7[_xo100vh[i]*16 +2];
        if (_t4q9bc2[_xo100vh[i]*8 +5] == 1u)
        { _3n3bzt9[i*16 +9] = 0.0f;
            _3n3bzt9[i*16 +10] = 0.0f;
            _3n3bzt9[i*16 +13] = 0.001f*_qw5dsk7[_xo100vh[i]*16 +4] *cosf(_qw5dsk7[_xo100vh[i]*16 +5]*(3.14159265358979323846264338327950288/180.0f));
            _3n3bzt9[i*16 +14] = 0.001f*_qw5dsk7[_xo100vh[i]*16 +4] *sinf(_qw5dsk7[_xo100vh[i]*16 +5]*(3.14159265358979323846264338327950288/180.0f));
        }
        else
        { _5bwikot[0] = sinf(_qw5dsk7[_xo100vh[i]*16 +5]*(3.14159265358979323846264338327950288/180.0f));
            _5bwikot[1] = cosf(_qw5dsk7[_xo100vh[i]*16 +5]*(3.14159265358979323846264338327950288/180.0f));
            _5bwikot[2] = 0.0f;
            _0dl5e11[0] = 1.0E+6f*_qw5dsk7[_xo100vh[i]*16 +4] *_5bwikot[0]*_5bwikot[0];
            _0dl5e11[1] = 1.0E+6f*_qw5dsk7[_xo100vh[i]*16 +4] *_5bwikot[0]*_5bwikot[1];
            _0dl5e11[2] = 1.0E+6f*_qw5dsk7[_xo100vh[i]*16 +4] *_5bwikot[0]*_5bwikot[2];
            _0dl5e11[3] = 1.0E+6f*_qw5dsk7[_xo100vh[i]*16 +4] *_5bwikot[1]*_5bwikot[1];
            _0dl5e11[4] = 1.0E+6f*_qw5dsk7[_xo100vh[i]*16 +4] *_5bwikot[1]*_5bwikot[2];
            _0dl5e11[5] = 1.0E+6f*_qw5dsk7[_xo100vh[i]*16 +4] *_5bwikot[2]*_5bwikot[2];
            RotStressG2L(_2292mtr, &_qw5dsk7[_xo100vh[i]*16 +6], _0dl5e11);
            _3n3bzt9[i*16 +9] = _2292mtr[0];
            _3n3bzt9[i*16 +10] = _2292mtr[1];
            _3n3bzt9[i*16 +13] = 0.0f;
            _3n3bzt9[i*16 +14] = 0.0f;
        }
    }
    for (i = 0u; i < _zfflb7w[_20n8tte]; i++)
    { _m7pyxdw[i*16 +8] = _rcpprcj[_g1ved32[i]*16 +15];
        _m7pyxdw[i*16 +9] = _rcpprcj[_g1ved32[i]*16 +3];
        _m7pyxdw[i*16 +10] = _rcpprcj[_g1ved32[i]*16 +4];
        _m7pyxdw[i*16 +11] = _rcpprcj[_g1ved32[i]*16 +5];
    }
    return;
}
void _z0yncxl(unsigned int _qy8yb7w, const unsigned int *restrict _06ftlo4, float *restrict _wkxxjve, const float *restrict _ypntrfz, float *restrict _h55rbc7, float *restrict _f445cri)
{ unsigned int i;
    float _9p3jpxg;
    float _2c9t199[3], _dxj37c9[3], _h42m44g[3], _961j88q[3], _eoz0kz4[3], _z7whwkm[3], _y9x8syl[3], _emruyp0[3], _5bwikot[3], _nvg3kk0[3];
    for (i = 0u; i < _qy8yb7w; i++)
    {
        ...
        SubtractVect3(_961j88q, _dxj37c9, _2c9t199); SubtractVect3(_eoz0kz4, _h42m44g, _2c9t199); SubtractVect3(_z7whwkm, _h42m44g, _dxj37c9);
        SubtractVect3(_y9x8syl, &_wkxxjve[i*16 +0], _2c9t199); SubtractVect3(_emruyp0, &_wkxxjve[i*16 +0], _dxj37c9);
        CrossProduct(_nvg3kk0,_961j88q, _y9x8syl); _9p3jpxg = 0.5f*VectorLength(_nvg3kk0); *_f445cri += ((2.0f*_9p3jpxg)/VectorLength(_961j88q));
        CrossProduct(_nvg3kk0,_eoz0kz4, _y9x8syl); _9p3jpxg = 0.5f*VectorLength(_nvg3kk0); *_f445cri += ((2.0f*_9p3jpxg)/VectorLength(_eoz0kz4));
        CrossProduct(_nvg3kk0,_z7whwkm, _emruyp0); _9p3jpxg = 0.5f*VectorLength(_nvg3kk0); *_f445cri += ((2.0f*_9p3jpxg)/VectorLength(_z7whwkm));
        CrossProduct(_5bwikot,_961j88q, _eoz0kz4); _wkxxjve[i*16 +15] = 0.5f*VectorLength(_5bwikot);
        *_h55rbc7 += _wkxxjve[i*16 +15];
    }
    *_f445cri = (_qy8yb7w > 0u) ? *_f445cri/((float)_qy8yb7w*3.0f) : *_f445cri;
    *_h55rbc7 = (_qy8yb7w > 0u) ? *_h55rbc7/ (float)_qy8yb7w : *_h55rbc7;
    return;
}
void _l4zkloo(int _20n8tte, unsigned int _pj8t22c, float *restrict _dhgzz0j, unsigned int _qy8yb7w, unsigned int *restrict _06ftlo4, float *restrict _wkxxjve, const float *restrict _ypntrfz, const unsigned int *restrict _qydbpgv, const int *restrict _zc7d2kd)
{
    unsigned int i, j, _81bmqf7;
    unsigned int _dn1th1x, _8h0imjy, _jcmrsez, _1b07g2r, _e6zvlhy, _l2ld05n, _hqr6f7q, _nezw9he;
    float _9p3jpxg = 0.0f, _h30153s, _vm59m6m;
    float _2c9t199[3], _dxj37c9[3], _h42m44g[3], _v3z6bz8[3], _961j88q[3], _eoz0kz4[3], _z7whwkm[3], _y9x8syl[3], _emruyp0[3], _5bwikot[3], _pt5r5rc[3], _glqj5sx[3], _nvg3kk0[3];
    struct { float _p8ijl2z; int _uuijnwp; } _ov6tt9q[1], _163yk03[1];
    for (_dn1th1x = 0u; _dn1th1x < _pj8t22c; _dn1th1x++)
    {
        _1b07g2r = 0u;
        for (i = 0u; i < _qy8yb7w; i++) { if (_06ftlo4[i*8 +3] == _dn1th1x) { _1b07g2r = i; break; } }
        _ov6tt9q[0]._uuijnwp = 0; _ov6tt9q[0]._p8ijl2z = 0.0f;
        _81bmqf7 = 0u; _vm59m6m = 0.0f;
        for (i = 0u; i < _zc7d2kd[_20n8tte]; i++)
        { if (_06ftlo4[_qydbpgv[i]*8 +3] == _dn1th1x)
            { for (j = 0u; j < 3u; j++)
                { SubtractVect3(_nvg3kk0, &_wkxxjve[_1b07g2r*16 +0], &_ypntrfz[ _06ftlo4[_qydbpgv[i]*8 +j]*4 +0]);
                    _9p3jpxg = VectorLength(_nvg3kk0);
                    _81bmqf7 = (_9p3jpxg < _vm59m6m)*_81bmqf7 + (_9p3jpxg >= _vm59m6m)*_06ftlo4[_qydbpgv[i]*8 +j];
                    _vm59m6m = (_9p3jpxg < _vm59m6m)*_vm59m6m + (_9p3jpxg >= _vm59m6m)*_9p3jpxg;
        } } }
        _ov6tt9q[0]._uuijnwp = _81bmqf7; _ov6tt9q[0]._p8ijl2z = _vm59m6m;
        MPI_Allreduce(_ov6tt9q, _163yk03, 1, ((MPI_Datatype)0x8c000000), (MPI_Op)(0x5800000c), ((MPI_Comm)0x44000000));
        _e6zvlhy = (unsigned int)_163yk03[0]._uuijnwp;
        _ov6tt9q[0]._uuijnwp = 0; _ov6tt9q[0]._p8ijl2z = 0.0f;
        _81bmqf7 = 0u; _vm59m6m = 0.0f;
        for (i = 0u; i < _zc7d2kd[_20n8tte]; i++)
        { if (_06ftlo4[_qydbpgv[i]*8 +3] == _dn1th1x)
            { for (j = 0u; j < 3u; j++)
                { SubtractVect3(_nvg3kk0, &_ypntrfz[_e6zvlhy*4 +0], &_ypntrfz[ _06ftlo4[_qydbpgv[i]*8 +j]*4 +0]);
                    _9p3jpxg = VectorLength(_nvg3kk0);
                    _81bmqf7 = (_9p3jpxg < _vm59m6m)*_81bmqf7 + (_9p3jpxg >= _vm59m6m)*_06ftlo4[_qydbpgv[i]*8 +j];
                    _vm59m6m = (_9p3jpxg < _vm59m6m)*_vm59m6m + (_9p3jpxg >= _vm59m6m)*_9p3jpxg;
        } } }
        _ov6tt9q[0]._uuijnwp = _81bmqf7; _ov6tt9q[0]._p8ijl2z = _vm59m6m;
        MPI_Allreduce(_ov6tt9q, _163yk03, 1, ((MPI_Datatype)0x8c000000), (MPI_Op)(0x5800000c), ((MPI_Comm)0x44000000));
        _l2ld05n = (unsigned int)_163yk03[0]._uuijnwp;
        _ov6tt9q[0]._uuijnwp = 0; _ov6tt9q[0]._p8ijl2z = 0.0f;
        _81bmqf7 = 0u; _vm59m6m = 0.0f;
        for (i = 0u; i < _zc7d2kd[_20n8tte]; i++)
        { if (_06ftlo4[_qydbpgv[i]*8 +3] == _dn1th1x)
            { for (j = 0u; j < 3u; j++)
                { SubtractVect3(_nvg3kk0, &_ypntrfz[_e6zvlhy*4 +0], &_ypntrfz[ _06ftlo4[_qydbpgv[i]*8 +j]*4 +0]);
                    _9p3jpxg = VectorLength(_nvg3kk0);
                    SubtractVect3(_nvg3kk0, &_ypntrfz[_l2ld05n*4 +0], &_ypntrfz[ _06ftlo4[_qydbpgv[i]*8 +j]*4 +0]);
                    _9p3jpxg += VectorLength(_nvg3kk0);
                    _81bmqf7 = (_9p3jpxg < _vm59m6m)*_81bmqf7 + (_9p3jpxg >= _vm59m6m)*_06ftlo4[_qydbpgv[i]*8 +j];
                    _vm59m6m = (_9p3jpxg < _vm59m6m)*_vm59m6m + (_9p3jpxg >= _vm59m6m)*_9p3jpxg;
        } } }
        _ov6tt9q[0]._uuijnwp = _81bmqf7; _ov6tt9q[0]._p8ijl2z = _vm59m6m;
        MPI_Allreduce(_ov6tt9q, _163yk03, 1, ((MPI_Datatype)0x8c000000), (MPI_Op)(0x5800000c), ((MPI_Comm)0x44000000));
        _hqr6f7q = (unsigned int)_163yk03[0]._uuijnwp;
        _ov6tt9q[0]._uuijnwp = 0; _ov6tt9q[0]._p8ijl2z = 0.0f;
        _81bmqf7 = 0u; _vm59m6m = 0.0f;
        for (i = 0u; i < _zc7d2kd[_20n8tte]; i++)
        { if (_06ftlo4[_qydbpgv[i]*8 +3] == _dn1th1x)
            { for (j = 0u; j < 3u; j++)
                { SubtractVect3(_nvg3kk0, &_ypntrfz[_e6zvlhy*4 +0], &_ypntrfz[_06ftlo4[ _qydbpgv[i]*8 +j]*4 +0]);
                    ...
                    SubtractVect3(_nvg3kk0, &_ypntrfz[_l2ld05n*4 +0], &_ypntrfz[_06ftlo4[ _qydbpgv[i]*8 +j]*4 +0]);
                    _9p3jpxg += VectorLength(_nvg3kk0);
                    SubtractVect3(_nvg3kk0, &_ypntrfz[_hqr6f7q*4 +0], &_ypntrfz[_06ftlo4[ _qydbpgv[i]*8 +j]*4 +0]);
                    _9p3jpxg += VectorLength(_nvg3kk0);
                    _81bmqf7 = (_9p3jpxg < _vm59m6m)*_81bmqf7 + (_9p3jpxg >= _vm59m6m)*_06ftlo4[_qydbpgv[i]*8 +j];
                    _vm59m6m = (_9p3jpxg < _vm59m6m)*_vm59m6m + (_9p3jpxg >= _vm59m6m)*_9p3jpxg;
        } } }
        _ov6tt9q[0]._uuijnwp = _81bmqf7; _ov6tt9q[0]._p8ijl2z = _vm59m6m;
        MPI_Allreduce(_ov6tt9q, _163yk03, 1, ((MPI_Datatype)0x8c000000), (MPI_Op)(0x5800000c), ((MPI_Comm)0x44000000));
        _nezw9he = (unsigned int)_163yk03[0]._uuijnwp;
        __builtin___memcpy_chk (_2c9t199, &_ypntrfz[_e6zvlhy*4 +0], 3*sizeof(float), __builtin_object_size (_2c9t199, 0));
        __builtin___memcpy_chk (_dxj37c9, &_ypntrfz[_l2ld05n*4 +0], 3*sizeof(float), __builtin_object_size (_dxj37c9, 0));
        __builtin___memcpy_chk (_h42m44g, &_ypntrfz[_hqr6f7q*4 +0], 3*sizeof(float), __builtin_object_size (_h42m44g, 0));
        __builtin___memcpy_chk (_v3z6bz8, &_ypntrfz[_nezw9he*4 +0], 3*sizeof(float), __builtin_object_size (_v3z6bz8, 0));
        SubtractVect3(_961j88q, _dxj37c9, _2c9t199); NrmlzeVect(_961j88q);
        SubtractVect3(_eoz0kz4, _h42m44g, _2c9t199); NrmlzeVect(_eoz0kz4);
        CrossProduct(_5bwikot, _961j88q, _eoz0kz4); NrmlzeVect(_5bwikot);
        if (_5bwikot[2] < 0.0f) { _5bwikot[0] *= -1.0f; _5bwikot[1] *= -1.0f; _5bwikot[2] *= -1.0f;}
        if ((_e6zvlhy == _nezw9he) || (_l2ld05n == _nezw9he) || (_hqr6f7q == _nezw9he))
        {
            _dhgzz0j[_dn1th1x*8 +3] = _5bwikot[0];
            _dhgzz0j[_dn1th1x*8 +4] = _5bwikot[1];
            _dhgzz0j[_dn1th1x*8 +5] = _5bwikot[2];
        }
        else
        {
            SubtractVect3(_961j88q, _2c9t199, _dxj37c9); NrmlzeVect(_961j88q);
            SubtractVect3(_eoz0kz4, _v3z6bz8, _dxj37c9); NrmlzeVect(_eoz0kz4);
            CrossProduct(_z7whwkm, _961j88q, _eoz0kz4); NrmlzeVect(_z7whwkm);
            _9p3jpxg = _5bwikot[0]*_z7whwkm[0] + _5bwikot[1]*_z7whwkm[1] + _5bwikot[2]*_z7whwkm[2];
            if (_9p3jpxg < 0.0f) { _z7whwkm[0] *= -1.0f; _z7whwkm[1] *= -1.0f; _z7whwkm[2] *= -1.0f;}
            SubtractVect3(_961j88q, _2c9t199, _h42m44g); NrmlzeVect(_961j88q);
            SubtractVect3(_eoz0kz4, _v3z6bz8, _h42m44g); NrmlzeVect(_eoz0kz4);
            CrossProduct(_y9x8syl, _961j88q, _eoz0kz4); NrmlzeVect(_y9x8syl);
            _9p3jpxg = _5bwikot[0]*_y9x8syl[0] + _5bwikot[1]*_y9x8syl[1] + _5bwikot[2]*_y9x8syl[2];
            if (_9p3jpxg < 0.0f) { _y9x8syl[0] *= -1.0f; _y9x8syl[1] *= -1.0f; _y9x8syl[2] *= -1.0f;}
            SubtractVect3(_961j88q, _dxj37c9, _v3z6bz8); NrmlzeVect(_961j88q);
            SubtractVect3(_eoz0kz4, _h42m44g, _v3z6bz8); NrmlzeVect(_eoz0kz4);
            CrossProduct(_emruyp0, _961j88q, _eoz0kz4); NrmlzeVect(_emruyp0);
            _9p3jpxg = _5bwikot[0]*_emruyp0[0] + _5bwikot[1]*_emruyp0[1] + _5bwikot[2]*_emruyp0[2];
            if (_9p3jpxg < 0.0f) { _emruyp0[0] *= -1.0f; _emruyp0[1] *= -1.0f; _emruyp0[2] *= -1.0f;}
            _dhgzz0j[_dn1th1x*8 +3] = _5bwikot[0] + _z7whwkm[0] + _y9x8syl[0] + _emruyp0[0];
            _dhgzz0j[_dn1th1x*8 +4] = _5bwikot[1] + _z7whwkm[1] + _y9x8syl[1] + _emruyp0[1];
            _dhgzz0j[_dn1th1x*8 +5] = _5bwikot[2] + _z7whwkm[2] + _y9x8syl[2] + _emruyp0[2];
        }
        NrmlzeVect(&_dhgzz0j[_dn1th1x*8 +3]);
        _9p3jpxg = 0.0f;
        for (i = 0u; i < _qy8yb7w; i++)
        { if (_06ftlo4[i*8 +3] == _dn1th1x)
            { _9p3jpxg += 1.0f;
                _dhgzz0j[_dn1th1x*8 +0] += _wkxxjve[i*16 +0];
                _dhgzz0j[_dn1th1x*8 +1] += _wkxxjve[i*16 +1];
                _dhgzz0j[_dn1th1x*8 +2] += _wkxxjve[i*16 +2];
                __builtin___memcpy_chk (_2c9t199, &_ypntrfz[_06ftlo4[i*8 +0]*4 +0], 3*sizeof(float), __builtin_object_size (_2c9t199, 0));
                __builtin___memcpy_chk (_dxj37c9, &_ypntrfz[_06ftlo4[i*8 +1]*4 +0], 3*sizeof(float), __builtin_object_size (_dxj37c9, 0));
                __builtin___memcpy_chk (_h42m44g, &_ypntrfz[_06ftlo4[i*8 +2]*4 +0], 3*sizeof(float), __builtin_object_size (_h42m44g, 0));
                SubtractVect3(_961j88q, _dxj37c9, _2c9t199); NrmlzeVect(_961j88q);
                SubtractVect3(_eoz0kz4, _h42m44g, _2c9t199); NrmlzeVect(_eoz0kz4);
                CrossProduct(_5bwikot, _961j88q, _eoz0kz4); NrmlzeVect(_5bwikot);
                _h30153s = _dhgzz0j[_dn1th1x*8 +3]*_5bwikot[0] + _dhgzz0j[_dn1th1x*8 +4]*_5bwikot[1] + _dhgzz0j[_dn1th1x*8 +5]*_5bwikot[2];
                _8h0imjy = (_h30153s < 0.0f)*1u + (_h30153s >= 0.0f)*0u;
                _jcmrsez = _06ftlo4[i*8 +1];
                _06ftlo4[i*8 +1] = (_8h0imjy == 0u)*_06ftlo4[i*8 +1] + (_8h0imjy != 0u)*_06ftlo4[i*8 +2];
                _06ftlo4[i*8 +2] = (_8h0imjy == 0u)*_06ftlo4[i*8 +2] + (_8h0imjy != 0u)*_jcmrsez;
                _5bwikot[0] = (_8h0imjy == 0u)*_5bwikot[0] + (_8h0imjy != 0u)*-_5bwikot[0];
                _5bwikot[1] = (_8h0imjy == 0u)*_5bwikot[1] + (_8h0imjy != 0u)*-_5bwikot[1];
                _5bwikot[2] = (_8h0imjy == 0u)*_5bwikot[2] + (_8h0imjy != 0u)*-_5bwikot[2];
                GetStkAndDipVect(_5bwikot, _pt5r5rc, _glqj5sx);
                __builtin___memcpy_chk (&_wkxxjve[i*16 +6], _5bwikot, 3*sizeof(float), __builtin_object_size (&_wkxxjve[i*16 +6], 0));
                __builtin___memcpy_chk (&_wkxxjve[i*16 +9], _pt5r5rc, 3*sizeof(float), __builtin_object_size (&_wkxxjve[i*16 +9], 0));
                __builtin___memcpy_chk (&_wkxxjve[i*16 +12], _glqj5sx, 3*sizeof(float), __builtin_object_size (&_wkxxjve[i*16 +12], 0));
        } }
        _dhgzz0j[_dn1th1x*8 +0] /= _9p3jpxg;
        _dhgzz0j[_dn1th1x*8 +1] /= _9p3jpxg;
        _dhgzz0j[_dn1th1x*8 +2] /= _9p3jpxg;
    }
    return;
}
