...
## SAMPLE OUTPUTS
Following a few example outputs, generated by MCQsim. We present the single-event quasi-dynamic evolution of a **M**7.54 normal faulting event along a listric fault with fault roughness and heterogeneous strength distribtion. Further presented are earthquake catalog and catalog derivates for the same fault.
